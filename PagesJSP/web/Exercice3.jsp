<%-- 
    Document   : Exercice3
    Created on : 12 déc. 2020, 11:37:33
    Author     : hp
--%>
...
%>
Nom	   Employe	   :	   <%=	   (Object)	   employe.elementAt(0)%> <br>
CNSS	   Employe	   :	   <%=	   (Object)	   employe.elementAt(1)%> <br>
Salaire	   Employe	   :	   <%=	   (Object)	   employe.elementAt(2)%> <br>
    </body>
</html>
